...
let ClientsController = class ClientsController {
    ...
    findAll(page, limit, status, hasPendingPayment, req) {
        return this.clientsService.findAll({ page, limit, status, hasPendingPayment }, req?.user?.id);
    }
    findOne(id, req) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'status', required: false, enum: ['LEAD', 'NEGOTIATING', 'ACTIVE', 'INACTIVE', 'LOST'] }),
    (0, swagger_1.ApiQuery)({ name: 'hasPendingPayment', required: false, enum: ['true', 'false'] }),
    __param(0, (0, common_1.Query)('page')),
    __param(1, (0, common_1.Query)('limit')),
    __param(2, (0, common_1.Query)('status')),
    __param(3, (0, common_1.Query)('hasPendingPayment')),
