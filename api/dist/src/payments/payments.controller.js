...
let PaymentsController = class PaymentsController {
    ...
    findAll(page, limit, project_id, status, req) {
        return this.paymentsService.findAll({ page, limit, project_id, status }, req?.user?.id);
    }
    findOne(id, req) {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Criar parcela de pagamento' }),
