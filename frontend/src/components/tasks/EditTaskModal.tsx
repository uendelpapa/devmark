...
import { Xmark, ArrowUpRightFromSquare, Ellipsis, FloppyDisk, TrashBin, Flag, Plus, Briefcase } from '@gravity-ui/icons'
import { useNavigate } from '@tanstack/react-router'

import { useQuery } from '@tanstack/react-query'
import { fetchProjects, fetchTasks } from '../../services/api'
import type { Task, TaskCardData } from '../../services/api'
import { Input, Button, DatePicker, DateField, TimeField, Checkbox, Calendar, Label } from '@heroui/react'
...
interface EditTaskModalProps {
  isOpen: boolean
  onClose: () => void
  onSubmit: (data: Partial<CreateTaskPayload>) => void
  onDelete?: () => void
