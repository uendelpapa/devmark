...
export function KpiCard({
  ...
  return (
    <div
      className={`border rounded-3xl p-5 shadow-xs flex flex-col justify-between min-h-[140px] ${isPrimary
    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        <span
          className={`flex items-center gap-0.5 text-[10px] font-bold px-2 py-0.5 rounded-full ${isPositive
      ...
      <div className="mt-4">
        ...
        <span className={`text-2xl font-extrabold tracking-tight ${isPrimary ? 'text-secondary' : 'text-zinc-800'}`}>
          {value}
        </span>
      </div>
