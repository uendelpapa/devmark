...
import { E as require_jsx_runtime, S as Avatar, x as Button, y as Card } from "../_libs/@heroui/react+[...].mjs";
import { D as updateClient, _ as fetchClients, c as deleteClient } from "./api-Beqz3ccz.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/clientes-CKSttv1z.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 flex-1 min-h-0",
				...
				className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 overflow-y-auto scrollbar-none pb-4",
