...
import { S as Avatar, T as require_jsx_runtime, i as Modal, x as Button } from "../_libs/@heroui/react+[...].mjs";
import { D as updateProject, u as deleteProject, y as fetchProjects } from "./api-CPpqugVW.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { A as Ellipsis, W as Check, b as Layers, n as TrashBin, s as Plus, u as PencilToLine } from "../_libs/gravity-ui__icons.mjs";
import { t as Button$1 } from "./Button-CKIMbDdG.mjs";
import { p as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as SelectItem, t as Select$1 } from "./Select-DN4KSzcs.mjs";
import { t as Route } from "./projetos-C1iWgdS7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/projetos-DDfLoQrq.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						className: "font-semibold text-zinc-800 text-lg leading-tight truncate",
						children: name
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-zinc-600 text-sm leading-tight truncate",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: `text-[11px] font-semibold rounded-full px-2 py-0.5 ${STATUS_STYLES[status]}`,
						children: STATUS_LABELS[status]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: `text-[11px] font-semibold rounded-full px-2 py-0.5 ${PRIORITY_STYLES[priority]}`,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-zinc-800 leading-tight truncate",
							children: client_name
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-zinc-600 leading-tight truncate",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select$1, {
							...
							}), PROJECT_STATUSES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								id: s.key,
								textValue: s.label,
								children: s.label
							}, s.key))]
