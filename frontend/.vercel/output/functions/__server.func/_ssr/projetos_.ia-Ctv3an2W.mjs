...
import { S as Button, T as require_jsx_runtime } from "../_libs/@heroui/react+[...].mjs";
import { n as api } from "./axios-CZGDF9fW.mjs";
import { G as ChevronLeft, a as Sliders, h as Microphone, i as Sparkles, m as Paperclip, q as Check, t as Xmark, tt as ArrowRight } from "../_libs/gravity-ui__icons.mjs";
import { p as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/projetos_.ia-Ctv3an2W.js
...
function ProjetoIA() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bg-white rounded-2xl p-8 overflow-hidden min-w-0 flex-1 scrollbar-none flex flex-col relative h-full max-h-[calc(100vh-100px)]",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "flex items-center gap-3",
					children: [projectData && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "w-full bg-[#f4f4f5] rounded-2xl flex flex-col pt-4 pb-3 px-4 shadow-sm border border-transparent focus-within:border-zinc-300 transition-colors shrink-0",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between border-t border-zinc-200/80 pt-3 mt-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center text-xs font-medium transition-colors text-zinc-600",
									...
									className: "flex items-center gap-3",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										className: "text-secondary/60 hover:text-secondary transition-colors p-1 cursor-pointer",
										disabled: isLoading || isComplete,
