...
import { S as Avatar, T as require_jsx_runtime, w as IconPlus } from "../_libs/@heroui/react+[...].mjs";
import { A as updateTaskStatus, D as updateProject, d as deleteProjectExpense, i as createProjectExpense, l as deletePayment, n as createPayment, p as deleteTask, v as fetchProjectDetails } from "./api-CPpqugVW.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { F as Clock, H as ChevronLeft, J as Briefcase, M as CommentDot, P as ClockArrowRotateLeft, R as CircleDollar, W as Check, b as Layers, d as Pencil, k as EnvelopeOpen, n as TrashBin, s as Plus, t as Xmark } from "../_libs/gravity-ui__icons.mjs";
import { t as Button$1 } from "./Button-CKIMbDdG.mjs";
import { p as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as SelectItem, t as Select$1 } from "./Select-DN4KSzcs.mjs";
import { t as Route } from "./projetos_._projectId-B5rtPnHl.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/projetos_._projectId-BZwz8mRJ.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								...
								className: "w-full",
								children: PAYMENT_STATUSES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
									id: s.key,
									children: s.label
								}, s.key))
							})]
...
function ProjectDetailsPage() {
	...
	const [isEditingDates, setIsEditingDates] = (0, import_react.useState)(false);
	const [editStartDate, setEditStartDate] = (0, import_react.useState)("");
	const [editDeliveryDate, setEditDeliveryDate] = (0, import_react.useState)("");
	const [editName, setEditName] = (0, import_react.useState)("");
	const [isBudgetModalOpen, setIsBudgetModalOpen] = (0, import_react.useState)(false);
	const [newBudgetValue, setNewBudgetValue] = (0, import_react.useState)("");
	...
	(0, import_react.useEffect)(() => {
		if (project) {
			...
			if (project.description !== void 0) setEditDescription(project.description || "");
		}
	}, [project]);
	...
	const { mutate: handleUpdateTaskStatus } = useMutation({
		...
		onMutate: async ({ id, status }) => {
			...
			queryClient.setQueryData(["projectDetails", projectId], (old) => {
				if (!old) return old;
				return {
					...old,
					tasks: old.tasks?.map((task) => task.id === id ? {
						...task,
						status
					} : task)
				};
		...
		onError: (_err, _variables, context) => {
			if (context?.previousProject) queryClient.setQueryData(["projectDetails", projectId], context.previousProject);
		},
		onSettled: () => {
			queryClient.invalidateQueries({ queryKey: ["projectDetails", projectId] });
			queryClient.invalidateQueries({ queryKey: ["dashboard"] });
	...
	const getStatusInfo = (status) => {
		switch (status) {
			case "PLANNING": return {
				label: "Planejamento",
				bg: "bg-blue-200 border border-blue-400 text-zinc-900"
			};
			case "IN_PROGRESS": return {
				label: "Em Andamento",
				bg: "bg-amber-200 border border-amber-400 text-zinc-900"
			};
			case "WAITING_CLIENT": return {
				label: "Aguardando Cliente",
				bg: "bg-purple-200 border border-purple-400 text-zinc-900"
			};
			case "REVIEW": return {
				label: "Revisão",
				bg: "bg-indigo-200 border border-indigo-400 text-zinc-900"
			};
			case "COMPLETED": return {
				label: "Concluído",
				bg: "bg-emerald-200 border border-emerald-400 text-zinc-900"
			};
			case "CANCELED": return {
				label: "Cancelado",
				bg: "bg-rose-200 border border-rose-400 text-zinc-900"
			};
			default: return {
				label: status,
				bg: "bg-zinc-200 border border-zinc-400 text-zinc-900"
			};
		}
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "text-3xl font-medium tracking-tight text-zinc-700 leading-none",
							children: "Carregando..."
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "inline-grid items-center -ml-3 max-w-full",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "col-start-1 row-start-1 invisible whitespace-pre overflow-hidden text-3xl font-bold tracking-tight px-3",
								children: editName || "Nome do projeto"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "text",
								value: editName,
								onChange: (e) => setEditName(e.target.value),
								onBlur: () => {
									if (editName.trim() && editName.trim() !== project?.name) handleUpdateProject({ name: editName.trim() });
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "bg-zinc-100 border border-zinc-200 text-secondary font-medium px-2 py-1 rounded-full text-xs flex items-center gap-1.5",
							...
							!isLoading && project?.area && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex gap-1 bg-zinc-100 border border-zinc-200 text-secondary font-medium px-2 py-1 rounded-full text-xs",
								children: [project.area === "DEVELOPER" ? "Desenvolvimento" : "Marketing", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						className: "mt-1",
						children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block h-12 bg-zinc-100 animate-pulse rounded-xl w-[600px]" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
							value: editDescription,
							onChange: (e) => setEditDescription(e.target.value),
							onBlur: () => {
								const trimmed = editDescription.trim();
								if (trimmed !== (project?.description || "")) handleUpdateProject({ description: trimmed });
							},
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "shrink-0 bg-primary/50 border border-primary rounded-2xl px-3 py-2 flex flex-col gap-2 text-secondary relative group",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-4 mt-0.5" }), isEditingDates ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											className: "bg-white/50 border-none rounded px-2 py-0.5 text-xs outline-none"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center justify-between gap-2",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											className: "px-2 py-1 rounded text-[10px] font-semibold bg-zinc-100/50 hover:bg-zinc-100 text-secondary border-none cursor-pointer transition-colors",
											children: "Cancelar"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: () => {
												handleUpdateProject({
											...
											className: "px-2 py-1 rounded text-[10px] font-semibold bg-white text-secondary border-none cursor-pointer hover:bg-zinc-50 transition-colors",
											children: "Salvar"
										})]
									})
								]
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex flex-col text-sm pr-4",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "font-medium",
										children: ["Início: ", formatDate(project?.start_date || project?.created_at || "")]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "font-medium",
										children: ["Entrega: ", project?.expected_delivery_date ? formatDate(project?.expected_delivery_date) : "Sem prazo"]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										onClick: () => {
						...
						className: "shrink-0 bg-primary/50 border border-primary rounded-2xl px-3 py-2 flex items-center gap-2 text-secondary",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClockArrowRotateLeft, { className: "size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "lg:col-span-2 bg-zinc-100 border border-zinc-200 rounded-2xl p-4 flex flex-col gap-2",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						allTasks.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: allTasks.map((task) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: `font-bold text-[14px] truncate transition-colors ${task.status === "COMPLETED" ? "text-secondary/50 line-through" : "text-secondary"}`,
											children: task.title
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										className: "grid shrink-0 justify-items-end items-center min-h-[32px] min-w-[72px]",
										children: [task.worked_hours !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "col-start-1 row-start-1 flex flex-col items-end shrink-0 transition-all duration-300 group-hover:opacity-0 group-hover:-translate-x-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											className: "col-start-1 row-start-1 flex items-center gap-2 transition-all duration-300 opacity-0 translate-x-2 group-hover:translate-x-0 group-hover:opacity-100 z-10",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
												size: "sm",
												className: `size-8 p-0 min-w-8 rounded-full border-none flex items-center justify-center duration-300 ease-in-out transition-colors cursor-pointer ${task.status === "COMPLETED" ? "bg-secondary/50 hover:bg-secondary text-white" : "bg-secondary hover:bg-secondary/50 text-white"}`,
												onClick: (e) => {
													e.stopPropagation();
												...
												onClick: (e) => {
													e.stopPropagation();
													if (confirm("Deseja excluir esta tarefa?")) handleDeleteTask(task.id);
												},
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "size-8 text-secondary/25" }),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$1, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconPlus, {}), "Adicionar Tarefas"]
								})
							]
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "bg-zinc-100 border border-zinc-200 rounded-2xl p-4 flex items-center justify-center",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "bg-primary/50 border border-primary p-6 rounded-3xl flex flex-col gap-4 relative group",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								className: "flex justify-center relative items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleDollar, { className: "size-4 text-secondary group-hover:opacity-0 opacity-100 transition-opacity duration-300" })]
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "bg-zinc-100 border border-zinc-200 p-6 rounded-3xl flex flex-col gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-zinc-800 font-semibold",
								children: "Faturado"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleDollar, { className: "size-4 text-zinc-800" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bg-zinc-100 border border-zinc-200 rounded-2xl p-4 flex flex-col gap-2",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			project && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EditProjectModal, {
			...
			isBudgetModalOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								className: "text-secondary/60 text-xs font-bold uppercase tracking-wider",
								children: "Novo Orçamento (R$)"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative w-full",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "absolute left-4 top-1/2 -translate-y-1/2 text-secondary/50 text-sm font-semibold z-10",
									children: "R$"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									type: "number",
									step: "0.01",
									...
									className: "w-full bg-zinc-50 border border-zinc-200 rounded-xl pl-10 pr-4 py-2.5 text-secondary text-sm outline-none focus:border-primary/60 focus:ring-2 focus:ring-primary/30 transition-all font-semibold",
									placeholder: "0.00",
									autoFocus: true,
									onKeyDown: (e) => {
										if (e.key === "Enter") {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => setIsBudgetModalOpen(false),
								className: "flex-1 py-2.5 rounded-xl font-bold text-sm bg-zinc-100 text-zinc-600 hover:bg-zinc-200 transition-all cursor-pointer border-none",
								children: "Cancelar"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => {
									const val = parseFloat(newBudgetValue);
								...
								disabled: !newBudgetValue || isNaN(parseFloat(newBudgetValue)),
								className: "flex-1 py-2.5 rounded-xl font-bold text-sm bg-secondary text-white hover:bg-secondary/90 transition-all cursor-pointer border-none disabled:opacity-50 disabled:cursor-not-allowed",
								children: "Salvar"
							})]
						})
					]
...
var labelClass = "text-secondary/60 text-xs font-bold uppercase tracking-wider";
function EditProjectModal({ isOpen, onClose, onSubmit, project, isPending = false }) {
	const [area, setArea] = (0, import_react.useState)(project.area || "DEVELOPER");
	(0, import_react.useEffect)(() => {
		if (isOpen && project) setArea(project.area || "DEVELOPER");
	}, [isOpen, project]);
	if (!isOpen) return null;
	const handleSubmit = () => {
		onSubmit({ area });
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						selectedKey: area,
						onSelectionChange: (key) => setArea(key),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "px-0 pt-2 flex items-center gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: onClose,
