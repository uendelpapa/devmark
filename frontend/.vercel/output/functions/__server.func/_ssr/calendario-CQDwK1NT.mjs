...
import { i as createTask, l as fetchCalendarItems } from "./api-C8eLQxfJ.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { G as ChevronLeft, W as ChevronRight, c as Plus, t as Xmark } from "../_libs/gravity-ui__icons.mjs";
import { t as CreateTaskModal } from "./CreateTaskModal-DgENZ96R.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/calendario-CQDwK1NT.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: VIEW_BUTTONS.map(({ key, label }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `${viewMode === key ? "bg-primary/50 text-secondary hover:bg-primary" : "bg-secondary text-white hover:bg-secondary/80"} font-bold rounded-full px-4 h-9 border-none text-[13px] transition-colors cursor-pointer`,
					children: label
				}, key))
			})]
