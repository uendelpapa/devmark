...
import { C as Avatar, T as require_jsx_runtime } from "./_libs/@heroui/react+[...].mjs";
import { i as useAuthStore } from "./_ssr/axios-B7sqCQdD.mjs";
import { n as logoutUser } from "./_ssr/auth-SemYZqoY.mjs";
import { h as fetchTasks, p as fetchProjects, u as fetchClients } from "./_ssr/api-CpUZCTJ1.mjs";
import { n as useQuery } from "./_libs/tanstack__react-query.mjs";
import { J as ChartMixed, Q as Bell, T as Folder, X as Calendar, a as Sliders, b as Layers3Diagonal, et as ArrowRightFromSquare, g as Magnifier, j as Envelope, s as Rectangles4, u as Persons, z as CircleQuestion } from "./_libs/gravity-ui__icons.mjs";
import { n as TimerTracker, t as TimerProvider } from "./_ssr/TimerTracker-CwDRv6YZ.mjs";
import { a as useLocation, c as Outlet, f as Link, p as useNavigate } from "./_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_authenticated-D9jEIFxJ.js
...
function MenuItem({ icon: Icon, label, badge, href, onClick }) {
	...
	const hoverColor = label === "Logout" ? "group-hover:text-red-500" : "group-hover:text-backpage";
...
function Header() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			ref: searchRef,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Magnifier, { className: "size-4 absolute top-1/2 left-3.5 -translate-y-1/2 text-secondary/50 z-10" }),
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "size-8 rounded-full bg-primary/50 flex items-center justify-center cursor-pointer hover:bg-primary transition-colors",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Envelope, { className: "text-secondary size-4" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					className: "size-8 rounded-full bg-primary/50 flex items-center justify-center relative cursor-pointer hover:bg-primary transition-colors",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bell, { className: "text-secondary size-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute top-2 right-2 w-2 h-2 bg-red-400 rounded-full border border-white" })]
				}),
