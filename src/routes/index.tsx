            ...
            <CardContent className="p-0">
              ...
              <div className="w-full flex items-end justify-between gap-3 px-2">
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  <div 
                    title={`Segunda-feira: ${weeklyWorkLevel[0]}h`}
                    style={{ height: `${getBarHeight(weeklyWorkLevel[0], 108)}px` }}
                    className="flex w-full max-w-[256px] bg-[#BAF08A] rounded-full transition-all hover:opacity-90" 
                  />
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  <div 
                    title={`Terça-feira: ${weeklyWorkLevel[1]}h`}
                    style={{ height: `${getBarHeight(weeklyWorkLevel[1], 146)}px` }}
                    className="flex w-full max-w-[256px] bg-[#8cb870] rounded-full transition-all hover:opacity-90" 
                  />
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  <div 
                    title={`Quarta-feira: ${weeklyWorkLevel[2]}h`}
                    style={{ height: `${getBarHeight(weeklyWorkLevel[2], 88)}px` }}
                    className="flex w-full max-w-[256px] bg-[#BAF08A] rounded-full transition-all hover:opacity-90" 
                  />
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  ...
                  <div
                    title={`Quinta-feira: ${weeklyWorkLevel[3]}h`}
                    className="flex w-full max-w-[256px] rounded-full transition-all hover:opacity-90 border-[1.5px] border-secondary"
                    style={{
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  <div 
                    title={`Sexta-feira: ${weeklyWorkLevel[4]}h`}
                    style={{ height: `${getBarHeight(weeklyWorkLevel[4], 120)}px` }}
                    className="flex w-full max-w-[256px] bg-[#BAF08A] rounded-full transition-all hover:opacity-90" 
                  />
                  <span className="text-xl font-medium">s</span>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  <div
                    title={`Sábado: ${weeklyWorkLevel[5]}h`}
                    className="flex w-full max-w-[256px] rounded-full transition-all hover:opacity-90 border-[1.5px] border-secondary"
                    style={{
                ...
                <div className="flex-1 flex flex-col items-center gap-2">
                  <div 
                    title={`Domingo: ${weeklyWorkLevel[6]}h`}
                    style={{ height: `${getBarHeight(weeklyWorkLevel[6], 65)}px` }}
                    className="flex w-full max-w-[256px] bg-[#BAF08A] rounded-full transition-all hover:opacity-90" 
                  />
